...
import javax.swing.JTextField;
	...
	public class ChessClockExample  implements KeyListener, Runnable, ActionListener
	{
		JFrame frame1,frame2;
		Panel p;
		Thread counter;
		JLabel label1,label2,label3,label4,label5,label6;
		JTextField player1,player2,time;
		JButton start;
		String p1,p2;
		int timelimit,p1remaining,p2remaining;
		boolean started,isCurrentPlayerPlayerOne;
		public static void main(String args[]) throws InterruptedException
		{
			JFrame.setDefaultLookAndFeelDecorated(true);
			ChessClockExample o = new ChessClockExample();
			o.m1();
		}
		public void m1()
		{
